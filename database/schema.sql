...
CREATE TABLE IF NOT EXISTS agenda_escalas (
  ...
  intervalo_entre_atendimentos_min INTEGER NOT NULL DEFAULT 0,
  almoco_inicio TEXT,
  almoco_fim TEXT,
...
CREATE TABLE IF NOT EXISTS regulacao_principal_acessos (
  ...
  gestor INTEGER NOT NULL DEFAULT 0 CHECK (gestor IN (0,1)),
...
-- versão final definida no bloco 2.25.0 ao fim deste arquivo


-- eMulti / Regulação 2.25.0 — estruturas exclusivamente gerenciais.
